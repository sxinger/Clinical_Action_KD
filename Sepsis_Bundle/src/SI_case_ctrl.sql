...
group by e.patient_num,e.encounter_num,e.triage_start,e.ed_dest_assgm1_dt,e.ed_dest_assgm1,e.ed_dest_assgm2_dt,e.ed_dest_assgm2,e.first_fact_dt,e.last_flosht_dt,e.enc_end
)
   ,ctrl_tri as (
select eu.patient_num,eu.encounter_num,eu.triage_start,eu.ed_dest_assgm1_dt,eu.ed_dest_assgm1,eu.ed_dest_assgm2_dt,eu.ed_dest_assgm2,
...
select tri.patient_num
      ...
      ,tri.triage_start
      ,tri.ed_dest_assgm1_dt
      ,tri.ed_dest_assgm1
      ,tri.ed_dest_assgm2_dt
      ,tri.ed_dest_assgm2
      ,tri.ed_last_note_dt
      ,tri.first_fact_dt
      ,tri.last_flosht_dt
      ...
      ,(tri.ed_dest_assgm1_dt-tri.triage_start)*24 dest1_since_triage
      ,(tri.ed_dest_assgm2_dt-tri.triage_start)*24 dest2_since_triage
...
select si.patient_num
      ...
      ,si.abx_since_triage
      ,si.si_since_triage
      ,round((tri.ed_dest_assgm1_dt-tri.triage_start)*24,2) dest1_since_triage
      ,round((tri.ed_dest_assgm2_dt-tri.triage_start)*24,2) dest2_since_triage
...
select ctrl.patient_num
      ...
      ,ctrl.triage_start
      ,ctrl.ed_dest_assgm1_dt
      ,ctrl.ed_dest_assgm1
      ,ctrl.ed_dest_assgm2_dt
      ,ctrl.ed_dest_assgm2
      ...
      ,round(ctrl.dest1_since_triage,2) dest1_since_triage
      ,round(ctrl.dest2_since_triage,2) dest2_since_triage
...
select cc.patient_num
      ...
      ,cc.antibio_subtype
      ,cc.triage_start
      ,cc.ed_dest_assgm1_dt
      ,cc.ed_dest_assgm1
      ,cc.ed_dest_assgm2_dt
      ,cc.ed_dest_assgm2
      ,cc.ed_last_note_dt   
      ,cc.first_fact_dt
      ,cc.last_flosht_dt
      ...
      ,cc.dest1_since_triage
      ,cc.dest2_since_triage
